...
async def killdabot(event):
    await event.edit("`RESTART KMVNG DULU....`")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#Restart \n"
                                        "KMVNG MULAI DI RESTART SABAR ASUH!")
    await bot.disconnect()
...
async def reedme(e):
    await e.edit(
        ...
        "\n[Yama README.md file](https://github.com/IrhamFadzillah/KMVNG/blob/master/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "╭••••••••••••••••𖠄••••••••••••••••╮\n \n[┣━•━─[ KMVNG ]─━•━┫](https://github.com/IrhamFadzillah/KMVNG) \n \n╰••••••••••••••••𖠄••••••••••••••••╯\n     \n"
    )
